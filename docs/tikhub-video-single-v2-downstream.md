# TikHub 获取单个作品数据 V2 下游对接文档

## 对接接口

```http
GET /api/public/tikhub/tiktok/video?aweme_id={aweme_id}
```

## 上游 TikHub 接口

```http
GET /api/v1/tiktok/app/v3/fetch_one_video_v2?aweme_id={aweme_id}
```
...
| 参数 | 位置 | 类型 | 必填 | 说明 |
|------|------|------|------|------|
| `aweme_id` | query | string | 是 | 作品 ID / Video ID，例如 `7350810998023949599` |
...
curl -H "Authorization: Bearer your_newapi_token" \
  "https://heharse.cloud/api/public/tikhub/tiktok/video?aweme_id=7350810998023949599"
```
