...
var affinityTestKeyCounter int64

func uniqueAffinityTestKey(prefix string) string {
	return fmt.Sprintf("%s_%d_%d", prefix, time.Now().UnixNano(), atomic.AddInt64(&affinityTestKeyCounter, 1))
}
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName := uniqueAffinityTestKey("rule")
	usingGroup := "default"
	keyFP := uniqueAffinityTestKey("fp")
