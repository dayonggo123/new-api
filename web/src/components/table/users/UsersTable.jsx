...
import UserFinanceModal from './modals/UserFinanceModal';
...
const UsersTable = (usersData) => {
  ...
  const showUserFinanceUserModal = (user) => {
    setModalUser(user);
  ...
  const columns = useMemo(() => {
    return getUsersColumns({
      ...
      showUserFinanceModal: showUserFinanceUserModal,
    });
  }, [
    t,
    setEditingUser,
  ...
  return (
    <>
      ...
      <UserFinanceModal
        visible={showUserFinanceModal}
        onCancel={() => setShowUserFinanceModal(false)}
        user={modalUser}
      />
    </>
  );
