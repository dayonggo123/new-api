...
const routerMap = {
  ...
  shared_templates: '/console/shared-templates',
  topup: '/console/topup',
  user: '/console/user',
  ...
  'tiktok-video-download': '/console/tools/tiktok-video-download',
};
...
const SiderBar = ({ onNavigate = () => {} }) => {
  ...
  const adminItems = useMemo(() => {
    ...
    const operationSubItems = [
      ...
      { text: t('模板审核'), itemKey: 'shared_templates', to: '/shared-templates', tooltip: { content: t('审核用户提交的工作流模板，通过后上线模板市场') } },
      ...
      { text: t('TikTok 视频下载'), itemKey: 'tiktok-video-download', to: '/console/tools/tiktok-video-download', tooltip: { content: t('TikTok 视频无水印下载工具，支持批量下载') } },
