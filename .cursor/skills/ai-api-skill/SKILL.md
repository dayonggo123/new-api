...
- **平台名称**：万象Ai
- **官网地址**：https://wanxiang88.lk666.ai
...
3. 如果都找不到，提示用户提供 API Key，并引导用户前往 万象Ai 官网（https://wanxiang88.lk666.ai）登录后在「API 密钥管理」中创建
...
3. **余额不足时**，提示用户前往 万象Ai 官网（https://wanxiang88.lk666.ai）充值算力
4. **API Key 错误时**，提示用户前往 万象Ai 官网（https://wanxiang88.lk666.ai）登录并在「API 密钥管理」中创建或检查密钥
